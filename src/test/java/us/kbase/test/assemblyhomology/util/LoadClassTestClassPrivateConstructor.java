...
public class LoadClassTestClassPrivateConstructor implements MinHashDistanceFilterFactory {

	private LoadClassTestClassPrivateConstructor(final Map<String, String> config) {}
