...
public abstract class LoadClassTestAbstractClass implements MinHashDistanceFilterFactory {

	public LoadClassTestAbstractClass(final Map<String, String> config) {}
